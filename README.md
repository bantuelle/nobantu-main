...
A modern, responsive portfolio website built with React, TypeScript, and Tailwind CSS. This portfolio showcases creative development work with a focus on clean design and smooth user experience.

## 🚀 Features

- **Modern Tech Stack**: Built with React 18, TypeScript, and Vite for optimal performance
- **Responsive Design**: Fully responsive layout that works seamlessly on all devices
- **UI Components**: Powered by shadcn/ui and Radix UI for accessible, customizable components
...
### Theming
The project uses Tailwind CSS with custom configuration. You can customize colors, fonts, and other design tokens in:
